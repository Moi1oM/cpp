...
using namespace orderbook::v2;

// Same message generator as v1
...
int main() {
    std::cout << "=== V2 Lock-Free Benchmark (SPSC Queue) ===" << std::endl;
    ...
    LockFreeHandler handler(latency);
    ...
    // Print results
    latency.printStats("V2 - Lock-Free SPSC Queue");
